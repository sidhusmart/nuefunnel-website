...
description: "A two-day workshop on getting real value out of coding agents — for engineering teams that have already tried them but struggled to use it with their codebase, infrastructure setup and architecture standards."
